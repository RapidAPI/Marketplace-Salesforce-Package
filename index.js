...
// app.post(`/api/${PACKAGE_NAME}/getAccessToken`, (req, res) => require('./blocks/getAccessToken.js')(req, res, template["GET"]));

// app.post(`/api/${PACKAGE_NAME}/getAllVersions`, require('./blocks/getAllVersions.js').getAllVersions);
// app.post(`/api/${PACKAGE_NAME}/getResourcesByVersion`,require ('./blocks/getResourcesByVersion.js').getResourcesByVersion);
// app.post(`/api/${PACKAGE_NAME}/getLimits`,require ('./blocks/getLimits.js').getLimits);
...
// app.post(`/api/${PACKAGE_NAME}/describeSingleObject`,require ('./blocks/describeSingleObject.js').describeSingleObject);
// app.post(`/api/${PACKAGE_NAME}/getObjectsDeletedRecords`,require ('./blocks/getObjectsDeletedRecords.js').getObjectsDeletedRecords);
// app.post(`/api/${PACKAGE_NAME}/getObjectsUpdatedRecords`,require ('./blocks/getObjectsUpdatedRecords.js').getObjectsUpdatedRecords);
...
/*
1)for loop in index for app.post
2)json  object for type of template to take (pass as param)
3)remove all comments
4)optional remove all exports ending
5)change GET template to be able to add headers
6)generate readme file
7)remove from git hub unnecessary files
8)create readme
...
example:
    ...
    const json = {};
    Object.keys(json).forEach(api => {
        const method = json[api];
        app[method]("/api/${api}/api.", )
